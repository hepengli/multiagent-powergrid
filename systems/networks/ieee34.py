...
def IEEE34Bus():
    ...
    # Shunt capacity bank
    pp.create_shunt_as_capacitor(net, bus_840, q_mvar=-0.12, name='SCB 1', step=1, max_step=4, loss_factor=0.0)
    pp.create_shunt_as_capacitor(net, bus_864, q_mvar=-0.12, name='SCB 2', step=1, max_step=4, loss_factor=0.0)
