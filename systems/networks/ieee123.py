...
def IEEE123Bus():
    ...
    # Shunt capacity bank
    pp.create_shunt_as_capacitor(net, bus_108, q_mvar=-0.3, name='SCB 1', step=1, max_step=4, loss_factor=0.0)
    pp.create_shunt_as_capacitor(net, bus_76,  q_mvar=-0.3, name='SCB 2', step=1, max_step=4, loss_factor=0.0)
